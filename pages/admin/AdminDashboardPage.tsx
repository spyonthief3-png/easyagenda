...
const AdminDashboardPage: React.FC = () => {
    ...
    const adminActions = [
        ...
        { name: 'Gerenciar Tipos de Sala', description: 'Cadastrar tipos como "Laboratório", "Auditório".', link: '/admin/room-types' },
        { name: 'Gerenciar Localizações', description: 'Cadastrar locais como "Bloco A", "Bloco B".', link: '/admin/locations' },
